...
namespace TJGenerators
{
    ...
    public static class TJGeneratorsGenerationService
    {
        public static TJGeneratorsTaskHandle Generate(ModelGeneratorBase generator, TJGeneratorsGenerationContext context = null, string sessionId = "")
        {
            ...
            switch (outputType)
            {
                case "sprite":          configType = ConfigType.Sprite; break;
                case "sprite_sequence": configType = ConfigType.SpriteSequence; break;
                case "material":        configType = ConfigType.Material; break;
                case "audio":           configType = ConfigType.Music; break;
